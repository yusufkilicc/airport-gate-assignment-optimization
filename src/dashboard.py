...
def _custom_tab():
    return html.Div([
        ...
        html.Div([
            html.Button("⬇ Flights template (Excel)", id="dl-flights-btn",
                        type="button", n_clicks=0, style=_BTN_STYLE),
            html.Button("⬇ Gates template (Excel)", id="dl-gates-btn",
                        type="button", n_clicks=0, style=_BTN_STYLE),
        ...
        html.Button("▶ Run optimization", id="custom-run", type="button", n_clicks=0,
